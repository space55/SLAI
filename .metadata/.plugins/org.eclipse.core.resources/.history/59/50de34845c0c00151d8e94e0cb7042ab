...
public class start
{
	...
	public static void yesNoQuestion(String input, Scanner in) throws IOException
	{
		...
		if (type == 2)
		{
			...
			System.out.println("My apoLogger.writeies, but I didn't understand your response. Would your response count as a \"Yes\" answer, a \"No\" answer, or a mess up?");
			...
			{
				Logger.write("SERVER IS BROKEN, FIX IT BEFORE IT EXPLODES");
			}
		}
		else if (type == 1)
		{
